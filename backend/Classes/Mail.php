...
namespace Mails{
    ...
    /**
     * SubscribtionMail is a class that handles what ever routin you want to do to the mail that will be sent to the subscribed clients.
     */
    class SubscribtionMail implements IMail
    {
        ...
        public function Send()
        {
            ...
            return mail($this->to, self::MESSAGE, self::SUBJECT);

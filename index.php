...
<head>
  ...
  <title>E-Coopera Comming Soon</title>

  <!-- Bootstrap core CSS -->
  <link href="vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">

  <link rel="shortcut icon" href="./img/Coop.png">
...
<body>
            ...
            <form action="backend\notifyme.php" method="post" name="notifyMeForm">
              ...
              <div class="input-group input-group-newsletter">
                ...
                <div class="input-group-append">
                  <input class="btn btn-secondary" type="submit" name="notifyMeSubmit" value="Notify Me">
                </div>
              </div>
            </form>
          </div>
  ...
  <div class="social-icons">
    <ul class="list-unstyled text-center mb-0">
      ...
      <li class="list-unstyled-item">
        <a href="https://www.facebook.com/ecooperaofficiel">
          <i class="fab fa-facebook-f"></i>
        </a>
      </li>
      <li class="list-unstyled-item">
        <a href="https://www.instagram.com/ecoopera.officiel/">
